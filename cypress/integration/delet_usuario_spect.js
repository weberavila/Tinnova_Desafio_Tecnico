describe('Deleta', () => {
    it('Deletar usuário', () => {
        ...
        cy.get(':nth-child(4) > [style="width: 15%; justify-content: flex-start;"] > :nth-child(3) > svg').click()
        cy.get(':nth-child(2) > .sc-iqcoie').focus().type(' santos').click()
        cy.get(':nth-child(2) > .sc-iqcoie').should('not.equal', 'Weber Avila santos')
        cy.get('.sc-bczRLJ').click()

        cy.get(':nth-child(4) > [style="width: 15%; justify-content: flex-start;"] > :nth-child(4) > svg').click()
